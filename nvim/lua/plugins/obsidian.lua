-- obsidian.lua: Configuration for Obsidian.nvim plugin
-- Integrates Neovim with your Obsidian vault for Markdown note-taking

return {
  workspaces = {
    {
      name = "Main",                        -- Name of your vault
      path = "/Users/sjoosten/Notes",        -- Path to your Obsidian vault
    },
  },
  notes_subdir = "Inbox",
